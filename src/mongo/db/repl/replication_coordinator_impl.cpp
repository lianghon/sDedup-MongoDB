...
namespace {
    ...
    HostAndPort ReplicationCoordinatorImpl::getMyHost() const {
        return _getMyHost_inlock();
    }

    HostAndPort ReplicationCoordinatorImpl::_getMyHost_inlock() const {
        const MemberConfig& self = _rsConfig.getMemberAt(_selfIndex);
        return self.getHostAndPort();
    }
